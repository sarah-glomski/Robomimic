        ...
        with h5py.File(data_path, "r") as f:
            ...
            for dataset_name in f.keys():
                ...
                if len(dataset.shape) == 1:
                    ...
                    print(f"  Image stack: {dataset.shape[0]} images, {dataset.shape[1]}x{dataset.shape[2]} pixels, {dataset.shape[3]} channels")
                elif len(dataset.shape) == 3:
                    if dataset.shape[2] > dataset.shape[1]:
                        print(f"  Depth stack: {dataset.shape[0]} images, {dataset.shape[1]}x{dataset.shape[2]} pixels")
                    else:
